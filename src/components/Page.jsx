    ...
    <>
      ...
      >
        ...
        >
          ...
          <Toolbar sx={{ gap: 2.3, display: { xs: "none", md: "flex" } }}>
            <Button
              sx={{
                borderRadius: "8px",
                color: "#333333",
      ...
      >
        ...
        >
          <Image src="/Rectangle31.png" layout="fill" className={"image"} />
            ...
            >
              ...
              <Button
                sx={{
                  ...
                  fontSize: "12px",
                  textTransform: "capitalize",
                  "&:hover": { backgroundColor: "#00DB4ADE", color: "#FFFFFF" },
                }}
              >
                Active
              </Button>
        ...
        >
          ...
          >
            <Typography
              sx={{ color: "#222", fontSize: "14px", fontWeight: "600" }}
            >
              Offline Alert
            </Typography>
            <p
              style={{ color: "#757575", fontSize: "13px", fontWeight: "400" }}
            >
            ...
            <Typography
              sx={{ color: "#222", fontSize: "13px", fontWeight: "600" }}
            >
              email.com
            </Typography>
          </Box>
          ...
          >
            ...
            <Typography
              sx={{ color: "#4CAF50", fontSize: "13px", fontWeight: "600" }}
            >
              Grade A
            </Typography>
          </Box>
        ...
        >
          ...
          >
            <Image src="/Rectangle1.png" layout="fill" className={"image"} />
            <Typography
              sx={{ color: "#222", fontSize: "14px", fontWeight: "600" }}
            >
              Recording_0121
            ...
            <Typography
              sx={{ color: "#757575", fontSize: "13px", fontWeight: "400" }}
            >
              Today, 04:42 pm
            </Typography>
          </Box>
          ...
          >
            <Image src="/Rectangle2.png" layout="fill" className={"image"} />
            <Typography
              sx={{ color: "#222", fontSize: "14px", fontWeight: "600" }}
            >
              Recording_0121
          ...
          >
            <Image src="/Rectangle3.png" layout="fill" className={"image"} />
            <Typography
              sx={{ color: "#222", fontSize: "14px", fontWeight: "600" }}
            >
              Recording_0121
          ...
          >
            <Image src="/Rectangle4.png" layout="fill" className={"image"} />
            <Typography
              sx={{ color: "#222", fontSize: "14px", fontWeight: "600" }}
            >
              Recording_0121
